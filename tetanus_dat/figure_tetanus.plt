...
plot "ca_acc_soma.dat" u 1:2 w lines ls 1 lw 1.8 title 'soma ca2+ inflx'
...
plot	"soma_cai_avg_tetanus.dat" u 1:2 w lines ls 2 lw 1.8 title 'soma cai avg',\
	"soma_cai_avg_tetanus.dat" u 1:3 w lines ls 3 lw 1.8 title 'soma cai'
set ylabel ("soma ca2+ concentration")
set xlabel ("time (ms)")
set xrange [0:1200]
set yrange [0:1]
set out 'soma_cai_avg_tetanus.png'
replot
