...
extern Memb_func* memb_func;
 ...
 "ghk_cal1", _hoc_ghk,
 "h2_cal1", _hoc_h2,
 "rates_cal1", _hoc_rates,
 "states_cal1", _hoc_states,
 0, 0
};
#define KTF KTF_cal1
#define _f_betm _f_betm_cal1
#define _f_alpm _f_alpm_cal1
#define alpm alpm_cal1
#define betm betm_cal1
#define efun efun_cal1
#define ghk ghk_cal1
#define h2 h2_cal1
...
#define eca eca_cal1
 double eca = 140;
#define gcal gcal_cal1
 double gcal = 0;
#define ki ki_cal1
 double ki = 0.001;
#define minf minf_cal1
 double minf = 0;
#define taum taum_cal1
 double taum = 0;
#define tfa tfa_cal1
 double tfa = 5;
#define usetable usetable_cal1
 double usetable = 1;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 7, 4);
 	...
 	ivoc_help("help ?1 cal1 /home/neuro/Documents/from_axon/ca1n1-mod/x86_64/cal1.mod\n");
...
static int _ode_count(int _type){ hoc_execerror("cal1", "cannot be used with CVODE"); return 0;}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 52 in file cal1.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
