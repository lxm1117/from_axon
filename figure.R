...
casyn0<-read.table("v_syn[0].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn1<-read.table("v_syn[1].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn2<-read.table("v_syn[2].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn3<-read.table("v_syn[3].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn4<-read.table("v_syn[4].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn5<-read.table("v_syn[5].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn6<-read.table("v_syn[6].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))
casyn7<-read.table("v_syn[7].dat", skip=5000, nrow=18000, col.names=c("time", "v_syn"))